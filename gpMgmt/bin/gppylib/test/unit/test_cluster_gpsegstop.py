...
class SegStopTestCase(unittest.TestCase):
    ...
    def test_get_datadir_and_port(self):
        self.segstop.db = '/data/gpseg0:1234' 
        self.assertEqual(['/data/gpseg0', '1234'], self.segstop.get_datadir_and_port())

    def test_get_datadir_and_port_empty_port(self):
        self.segstop.db = '/data/gpseg0'
        self.assertEqual(['/data/gpseg0'], self.segstop.get_datadir_and_port())
    ...
    @patch('gpsegstop.pg.ReadPostmasterTempFile.getResults', return_value=(True, 1234, '/data/gpseg0'))
    ...
    def test_run(self, mock1, mock2, mock3, mock4, mock5, mock6):
        ...
        expected = SegStopStatus('/data/gpseg0', True, 'Shutdown Succeeded')
    ...
    def test_run_with_error(self, mock1, mock2, mock3, mock4, mock5, mock6):
        ...
        self.segstop.mode = 'smart'
        self.segstop.timeout = '10'
        expected = SegStopStatus('/data/gpseg0', True, 'Forceful termination success')
        result = self.segstop.run()
    ...
    def test_run_with_pg_controldata_error_in_immediate_mode(self, mock1, mock2, mock3, mock4, mock5, mock6):
        ...
        self.segstop.timeout = '10'
        expected = SegStopStatus('/data/gpseg0', True, 'Shutdown Immediate')
        result = self.segstop.run()
        self.assertEqual(str(expected), str(result))
